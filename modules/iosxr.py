...
class IosXr(CommonMethods):
    """
    Class for a Cisco IOS-XR based system
    """
    def __init__(self, crt=None, ticket=None):
        ...
        self.image_version_regex = re.compile(r'Version \d+\.\d+\.\d+', re.IGNORECASE)
        ...
        self.pim_regex = re.compile(r'router pim')
